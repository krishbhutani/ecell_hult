export default function HultPrizeAtNITHamirpur() {
  return (
    <div className="flex flex-col h-screen">
      <header className="flex justify-between items-center bg-pink-400 text-white font-semibold text-lg h-80 px-5 py-10">
        <div className="flex items-center">
          <span className='mr-5 md:mx-5'>
            <img 
              ...
              alt="NIT Logo" 
              className="h-15 w-16 md:h-20 lg:h-24" // Responsive height
            />
          </span>
